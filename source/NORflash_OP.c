...
u32 Loadfile2NOR(TCHAR *filename, u32 NORaddress,u16 have_patch,u8 SAVEMODE)
{
	...
	if(norid == 0x223D)//S98
	{
		...
		*((vu16 *)(FlashBase_S98+0x000*2)) = 0x00 ;			
		...
		//DrawHZText12(gl_writing,0,70,160-15,0x7fff,1); BAK
        DrawHZText12(gl_writing,0,70,160-15,0xffff,1);		
		...
		{		
			...
			//DrawHZText12(msg,0,70+54,160-15,0x7fff,1); BAK
			DrawHZText12(msg,0,70+54,160-15,0xffff,1);
